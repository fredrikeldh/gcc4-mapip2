...
cd ~/code/mosync-mapip2 && ./workfile.rb more && \
cd ~/code/binutils && ./workfile.rb && \
cd ~/code/mosync-mapip2/libs/ResCompiler && ./workfile.rb && \
cd ~/code/mosync-mapip2/libs/MAStd && ./workfile.rb && \
...
cd ~/code/mosync-mapip2/examples/cpp/3dLines && ./workfile.rb run && \
